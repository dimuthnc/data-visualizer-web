...
LOAD DATA LOCAL INFILE '0118.txt' IGNORE INTO TABLE motionsensors_master
     FIELDS TERMINATED BY ' ' LINES TERMINATED BY '\n'
     (`sensor_id`, `start_time`, `end_time`, `avg_mag`);
LOAD DATA LOCAL INFILE '0119.txt' IGNORE INTO TABLE motionsensors_master
     FIELDS TERMINATED BY ' ' LINES TERMINATED BY '\n'
     (`sensor_id`, `start_time`, `end_time`, `avg_mag`);
LOAD DATA LOCAL INFILE '0120.txt' IGNORE INTO TABLE motionsensors_master
     FIELDS TERMINATED BY ' ' LINES TERMINATED BY '\n'
     (`sensor_id`, `start_time`, `end_time`, `avg_mag`);
LOAD DATA LOCAL INFILE '0121.txt' IGNORE INTO TABLE motionsensors_master
     FIELDS TERMINATED BY ' ' LINES TERMINATED BY '\n'
     (`sensor_id`, `start_time`, `end_time`, `avg_mag`);
LOAD DATA LOCAL INFILE '0122.txt' IGNORE INTO TABLE motionsensors_master
     FIELDS TERMINATED BY ' ' LINES TERMINATED BY '\n'
     (`sensor_id`, `start_time`, `end_time`, `avg_mag`);